  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between">
        ...
        {/* <button className="text-[10px] font-bold uppercase tracking-widest text-zinc-400 hover:text-black transition-colors px-4 py-2 bg-[#F8F9FB] rounded-full">
          Skip for now
        </button> */}
      </div>
      ...
      {/* Steps Timeline - Refined Industrial Aesthetic */}
      ...
      {/* Eligibility Info - Minimalist Alert */}
      <div className="flex items-start gap-3 p-5 bg-emerald-50/50 rounded-3xl border border-emerald-100/50">
        ...
        <p className="text-xs md:text-sm text-emerald-800 leading-relaxed font-normal">
          <span className="font-bold">Pro Tip:</span> To get eligible for accepting work and appearing in local searches, you need to complete your profile fully.
        </p>
      </div>

      {/* Primary Action Button - Heavy Industrial Black */}
      <button
        onClick={()=>onNext()}
        className="w-full py-5 rounded-[22px] bg-black text-white font-bold text-lg hover:bg-zinc-900 transition-all active:scale-[0.97] shadow-lg shadow-black/5"
      >
